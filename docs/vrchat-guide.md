...
```
"Build an observation deck world with fences and stairs"
"Set up night lighting and turn on the street lamps"
"Add a water surface with reflections"
"Place an AudioSource for BGM at the entrance"
"Set the spawn point at the entrance"
```
...
```
"Create a translucent glass material and apply it to the windows"
